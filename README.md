...
Design principles from the Progression modpack that guide this mod:

* We need a bubstantial amount of content, i.e. storage items are only removed if nescessary.
* The patched mods should deliver a cohesive experience, i.e. storage items should have comparable descriptions and intuitive balancing.
* Rimworld should be a pretty a game, i.e. usage of pretty storage items are incentivized.
...
+1 if the item is 1x2
+2 if the item is 2x2
